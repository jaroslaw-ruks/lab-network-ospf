...
Vagrant.configure(VAGRANT_API_VERSION) do |config|
    config.vm.define "ospf-r1-l1" do |v|
        ...
        v.vm.network "private_network", ip:"192.168.210.1",virtualbox__intnet: "ospf-network-l1"
   ...
   config.vm.define "ospf-c1-l1" do |v|
        v.vm.box = vm_box
        v.vm.network "private_network", ip:"192.168.210.101",virtualbox__intnet: "ospf-network-l1"
    ...
    config.vm.define "ospf-c1-l2" do |v|
        v.vm.box = vm_box
        v.vm.network "private_network", ip:"192.168.221.101",virtualbox__intnet: "ospf-network-l2-1"
    ...
    config.vm.define "ospf-c2-l2" do |v|
        v.vm.box = vm_box
        v.vm.network "private_network", ip:"192.168.222.101",virtualbox__intnet: "ospf-network-l2-2"
    ...
    config.vm.define "ospf-c1-l3" do |v|
        v.vm.box = vm_box
        v.vm.network "private_network", ip:"192.168.231.101",virtualbox__intnet: "ospf-network-l3-1"
