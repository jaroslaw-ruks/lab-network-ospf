...
Vagrant.configure(VAGRANT_API_VERSION) do |config|
	if r==1
	    config.vm.define "ospf-r1-l1" do |v|
	        ...
	        v.vm.network "private_network", ip:"192.168.210.1", netmask:"255.255.255.0", virtualbox__intnet: "ospf-network-l1"
	        ...
	        inline: "/bin/sh /vagrant/scripts/routers_part1.sh",  env: {"s" => s} 	        
	    ...
	    config.vm.define "ospf-r1-l2" do |v|
	        v.vm.box = vm_box
	        v.vm.network "private_network", ip:"192.168.210.2", netmask:"255.255.255.0",virtualbox__intnet: "ospf-network-l1"
	        v.vm.network "private_network", ip:"192.168.221.1", netmask:"255.255.255.0",virtualbox__intnet: "ospf-network-l2-1"
	    ...
	    config.vm.define "ospf-r2-l2" do |v|
	        v.vm.box = vm_box
	        v.vm.network "private_network", ip:"192.168.210.3", netmask:"255.255.255.0", virtualbox__intnet: "ospf-network-l1"
	        v.vm.network "private_network", ip:"192.168.222.1", netmask:"255.255.255.0", virtualbox__intnet: "ospf-network-l2-2"
	    ...
	    config.vm.define "ospf-r1-l3" do |v|
	        v.vm.box = vm_box
	        v.vm.network "private_network", ip:"192.168.222.2", netmask:"255.255.255.0", virtualbox__intnet: "ospf-network-l2-2"
	        v.vm.network "private_network", ip:"192.168.231.1", netmask:"255.255.255.0", virtualbox__intnet: "ospf-network-l3-1"
